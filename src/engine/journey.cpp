...
Journey::Journey(std::string name, const Day& day) :
    PeopleStats<Day> {name, JOURNEY_MIN_MASS, JOURNEY_MAX_MASS,
                      JOURNEY_MIN_PRICE, JOURNEY_MAX_PRICE, JOURNEY_MIN_FATS,
                      JOURNEY_MAX_FATS, JOURNEY_MIN_PROTEINS,
                      JOURNEY_MAX_PROTEINS, JOURNEY_MIN_CARBOHYDRATES,
                      JOURNEY_MAX_CARBOHYDRATES, JOURNEY_MIN_CALORIES,
                      JOURNEY_MAX_CALORIES, JOURNEY_MIN_AMOUNT_OF_DAYS,
                      JOURNEY_MAX_AMOUNT_OF_DAYS, JOURNEY_MIN_AMOUNT_OF_PEOPLE,
                      JOURNEY_MAX_AMOUNT_OF_PEOPLE} {
